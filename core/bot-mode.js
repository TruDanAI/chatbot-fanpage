...
const MENU_CODE_LIMITED_REPLY = 'Dạ mình xem qua menu trước giúp em nhé. Ưng mã nào mình nhắn mã đó, em tư vấn kỹ hơn ạ.';
...
function applyBotModeConfig(config = {}) {
  ...
  return {
    ...config,
    fallbackReply: MENU_CODE_LIMITED_REPLY,
    quickReplies: {
      ...(config.quickReplies || {}),
      enabled: false
    },
