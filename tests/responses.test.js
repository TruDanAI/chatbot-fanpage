...
describe('TEMPLATES coverage', () => {
  const required = [
    ...
    'orderInfoRequest', 'orderInfoReminder', 'orderIntentNoProduct', 'orderIntentWithProduct',
    ...
    'deliveryPreorder', 'deliveryDefault', 'trackingPending', 'trackingDefault', 'returnPolicy',
